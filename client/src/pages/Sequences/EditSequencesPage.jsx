...
      setError(null);
    }
    if (successMessage) { // Clear success message on new input
...
      setSuccessMessage("Sequence updated successfully!"); // Set success message
      // Optionally, navigate away or keep them on the page
      // navigate("/sequences");
    } catch (error) {
...
    setSuccessMessage(null); // Clear success message when opening dialog
  };
...
      },
    });
    handleCloseActionMenu(); // Close the action menu after triggering dialog
  };
